...
<\/script>`,id:`wn1OGMBZq`,loadMode:`always`,name:`Google Analytics`,pageIds:new Set([`pBeELKT9s`]),placement:`headStart`}],c=new r,l={RctWLXqQt:async(e,n)=>{let r={from:{alias:`RctWLXqQt`,data:(await import(`./I3Autv2jCkxTD3KB1tlcuf0eshl-qAd0B4zXDFLaDYI.DwaKsaBz.mjs`)).default,type:`Collection`},select:[{collection:`RctWLXqQt`,name:`ccQ0X4KxG`,type:`Identifier`},{collection:`RctWLXqQt`,name:`r8vKKoUPQ`,type:`Identifier`},{collection:`RctWLXqQt`,name:`Buzsonlu4`,type:`Identifier`}],where:t(e,`RctWLXqQt`)},i=await c.query(r,n);if(i.length===0)throw Error(`No data matches pathVariables`);return i[0]},vS7puIghp:async(e,n)=>{let r={from:{alias:`vS7puIghp`,data:(await import(`./slQkHRVC-jBAXMU1xvhpPvEy2vdPt-43Ka0kex5bNlI.JqcA5lHx.mjs`)).default,type:`Collection`},select:[{collection:`vS7puIghp`,name:`vKFaBGcFt`,type:`Identifier`}],where:t(e,`vS7puIghp`)},i=await c.query(r,n);if(i.length===0)throw Error(`No data matches pathVariables`);return i[0]}},u={bodyEnd:[],bodyStart:[],headEnd:[],headStart:[`bXT4v09CG`,`SIE3Fg0gV`,`VHhRV4KYP`,`mJ6WvRpw8`,`MzEmu6WpH`,`toSxig7iZ`,`Bnd3hgKUT`,`Au_LKE0I2`,`I8NjuxPFC`,`wn1OGMBZq`]},d={exports:{getSnippets:{type:`function`,annotations:{framerContractVersion:`1`}},snippetsSorting:{type:`variable`,annotations:{framerContractVersion:`1`}},__FramerMetadata__:{type:`variable`}}}}))();export{d as __FramerMetadata__,i as getSnippets,u as snippetsSorting};
//# sourceMappingURL=geSN9Th_h6zJuJzSVGKBKcu-LimRDMImlnm-d47dL-c.DWQPnLzR.mjs.map