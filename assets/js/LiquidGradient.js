// Liquid Gradient
import{defineShader,ControlType}from"framer";export default defineShader({title:"Liquid Gradient",resolutionScale:"consistent",fragment:`
// === CONSTANTS ===
...
`,propertyControls:{colors:{type:ControlType.Array,title:"Colors",control:{type:ControlType.Color},maxCount:8,defaultValue:["#00001A","#2962FF","#40BCFF","#FFB8B5","#FFC14F"]},seed:{type:ControlType.Number,title:"Seed",defaultValue:648,min:0,max:1e3,step:1},speed:{type:ControlType.Number,title:"Speed",defaultValue:.3,min:0,max:2,step:.01},loop:{type:ControlType.Number,title:"Loop",defaultValue:0,min:0,max:60,step:.5,hiddenWhenUnset:true,displayStepper:true},scale:{type:ControlType.Number,title:"Scale",defaultValue:.42,min:.1,max:2,step:.01},turbAmp:{type:ControlType.Number,title:"Amplitude",defaultValue:.6,min:0,max:1,step:.01},turbFreq:{type:ControlType.Number,title:"Frequency",defaultValue:.1,min:.1,max:2,step:.01},turbIter:{type:ControlType.Number,title:"Definition",defaultValue:7,min:3,max:10,step:1,displayStepper:true},waveFreq:{type:ControlType.Number,title:"Bands",defaultValue:3.8,min:.1,max:5,step:.1},distBias:{type:ControlType.Number,title:"Bias",defaultValue:0,min:-1,max:1,step:.1,hiddenWhenUnset:true},jellify:{type:ControlType.Boolean,title:"Jellify",defaultValue:false,hiddenWhenUnset:true},ditherMode:{type:ControlType.Enum,title:"Noise",options:[0,1,2],optionTitles:["Off","Smooth","Grain"],defaultValue:0},dither:{type:ControlType.Number,title:"Amount",defaultValue:.05,min:0,max:.2,step:.01,hidden:props=>props.ditherMode===0},exposure:{type:ControlType.Number,title:"Exposure",defaultValue:1.1,min:.5,max:2,step:.1,section:"Filters",displayStepper:true,hiddenWhenUnset:true},contrast:{type:ControlType.Number,title:"Contrast",defaultValue:1.1,min:.5,max:2,step:.1,section:"Filters",displayStepper:true,hiddenWhenUnset:true},saturation:{type:ControlType.Number,title:"Saturation",defaultValue:1,min:0,max:2,step:.1,section:"Filters",displayStepper:true,hiddenWhenUnset:true}}});
...
//# sourceMappingURL=./LiquidGradient.map